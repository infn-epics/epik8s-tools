...
{%- else %}
Phoebus settings were not generated by default.

Regenerate the project with `--generate-settings-ini` if you want `opi/settings.ini` to be created automatically.
{%- endif %}
